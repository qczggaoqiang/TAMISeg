...
if __name__ == "__main__":
    ...
    train_txt_path = '../TextDiff_code/datasets/Covid19/train.txt'
    val_txt_path = '../TextDiff_code/datasets/Covid19/test.txt'
    ...
    base_dir = "../TextDiff_code/datasets"
    ...
    """ Dataset """
    (train_x, train_y) = load_data(data_path, train_txt_path, train_flag = True)
    (valid_x, valid_y) = load_data(data_path, val_txt_path, train_flag = False)
